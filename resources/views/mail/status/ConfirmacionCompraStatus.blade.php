...
<head>
    ...
    <title>Confirmacion de compra. HHGLOBAL</title>
    <style>
        /* Estilos generales */
        body {
...
<body>
    <div class="container">
        <div class="inner-container">
            ...
            <p>El producto "{{ $nameProduct }}" con descripción: "{{ $descriptionProduct }}", ha cambiado de status a:</p>
            <b>{{ $status }}</b>
            <div class="btn-container">
                <a href="{{ $url }}" class="btn btn-primary">Ver mis compras</a>
            </div>
        </div>
